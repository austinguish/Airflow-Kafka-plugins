...
class KafkaConnector(BaseConnector):
    ...
    def _set_consumer(self, broker, group_id, client_id, timeout=5):
        ...
        if not self.consumer:
            self.consumer = Consumer({
                ...
                # [magic] add this line for reschedule consumer to work...
                'session.timeout.ms': (timeout + 1) * 1000,
    ...
    def _subscribe(self, topics):
        ...
        if self.consumer:
            ...
            raise ValueError(
                'consumer not set, can not assigined to any topic')
    ...
    def _consume_valid_messages(self, num_messages=1000, timeout=5):
        msg_list = self.consumer.consume(
